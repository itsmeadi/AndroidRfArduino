...
public class UsbService extends Service {
    ...
    private final BroadcastReceiver usbReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context arg0, Intent arg1) {
            Toast.makeText(getApplicationContext(), "usb receiver :102 supported=",Toast.LENGTH_LONG).show();
            if (arg1.getAction().equals(ACTION_USB_PERMISSION)) {
                ...
                Toast.makeText(getApplicationContext(), "usb receiver :118 serialPortConnected="+serialPortConnected,Toast.LENGTH_LONG).show();
    ...
    public void onCreate() {
        ...
        Toast.makeText(getBaseContext(), "ready usb servcie=",Toast.LENGTH_LONG).show();
